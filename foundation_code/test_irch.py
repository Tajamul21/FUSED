...
if __name__=="__main__":
    ...
    checkpoint_path = "vision_table_1/vitdino_8/model_best.pt"
    num_workers = 8
    batch_size = 4
    plot_path = './vision_table_1/vitdino_8/result_auc_IRCH.png'
    score_file = './vision_table_1/vitdino_8/result_scores_IRCH.txt'
    topk = 8
    img_size = 224
