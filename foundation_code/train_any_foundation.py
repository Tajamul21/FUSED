...
from test_clip import test_code, load_model_again
...
def load_data(CSV, IMG_BASE, TEXT_BASE, type=1, workers=8, batch_size=32, topk=5, img_size=224):
    ...
    # import ipdb; ipdb.set_trace()
    import ast
    train_targets = torch.tensor([ast.literal_eval(s) for s in train_targets])
...
def load_model_vitb16clip(class_num, layers_freeze, img_size):
...
def load_model_vitdino(class_num, layers_freeze, img_size):
    device = "cuda" if torch.cuda.is_available() else "cpu" 
    print(device)
...
def load_model_vitb16imgnet(class_num, layers_freeze, img_size):
    device = "cuda" if torch.cuda.is_available() else "cpu" 
    print(device)
...
def train_code(model, train_dataloader, val_dataloader, file_path, checkpoint_path, plot_path, num_epochs=50, learning_rate=5e-3):
    ...
    for epoch in range(num_epochs):
        ...
        for batch in pbar_train:
            ...
            logits = model(crops)
            # import ipdb; ipdb.set_trace()
            loss = loss_criterion(logits[0], labels)

            avg_loss_train += loss.item()
            batch_num_train += 1

            loss.backward()
            # doesnt work with vitdino
            try:
                model.module.convert_models_to_fp32()
            except:
                pass
            optimizer.step()
            # doesnt work with vitdino
            try:
                model.module.convert_weights()
            except:
                pass
...
if __name__=="__main__":
    ###### SET THESE ######
    # AIIMS -> INBreast
    TRAIN_CSV = "/home/keerti_km/scratch/Negroni_datasets/Coco_Data/BCD/AIIMS/train_id.csv"
    TRAIN_IMG_BASE = "/home/keerti_km/scratch/Negroni_datasets/Coco_Data/BCD/AIIMS/train2017"
    TRAIN_FND_CROPS = "/home/keerti_km/scratch/Negroni_datasets/Coco_Data/BCD/AIIMS/train2017_focalnet_crops"

    TEST_CSV = "/home/keerti_km/scratch/Negroni_datasets/Coco_Data/BCD/AIIMS/test_id.csv"
    TEST_IMG_BASE = "/home/keerti_km/scratch/Negroni_datasets/Coco_Data/BCD/AIIMS/val2017"
    TEST_FND_CROPS = "/home/keerti_km/scratch/Negroni_datasets/Coco_Data/BCD/AIIMS/val2017_focalnet_crops"
    ######################
    ...
    # SIM10k
    # TRAIN_CSV = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/Natural/sim10k/train_id.csv"
    # TRAIN_IMG_BASE = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/Natural/sim10k/train2017"
    # TRAIN_TEXT_BASE = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/Natural/sim10k/train2017_focalnet58_crops"

    # TEST_CSV = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/Natural/sim10k/test_id.csv"
    # TEST_IMG_BASE = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/Natural/sim10k/val2017"
    # TEST_TEXT_BASE = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/Natural/sim10k/val2017_focalnet58_crops"
    ...
    # KITTI
    # TRAIN_CSV = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/Natural/kitti/train_id.csv"
    # TRAIN_IMG_BASE = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/Natural/kitti/train2017"
    # TRAIN_TEXT_BASE = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/Natural/kitti/train2017_focalnet_crops"
    
    # TEST_CSV = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/Natural/kitti/val_id.csv"
    # TEST_IMG_BASE = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/Natural/kitti/val2017"
    # TEST_TEXT_BASE = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/Natural/kitti/val2017_focalnet_crops"
    
    # GBCNet
    # TRAIN_CSV = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/GBC/GBCNet/train_id.csv"
    # TRAIN_IMG_BASE = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/GBC/GBCNet/train2017"
    # TRAIN_TEXT_BASE = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/GBC/GBCNet/train2017_focalnet_crops"
    
    # TEST_CSV = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/GBC/GBCNet/val_id.csv"
    # TEST_IMG_BASE = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/GBC/GBCNet/val2017"
    # TEST_TEXT_BASE = "/home/kartik_anand/scratch/kstyles/miccai/NEGRONI_DATASETS/GBC/GBCNet/val2017_focalnet_crops"
    ...
    if args.model_type == "vitb16_clip":
        model = load_model_vitb16clip(class_num, layers_freeze, img_size)
    elif args.model_type == "vitdino":
        model = load_model_vitdino(class_num, layers_freeze, img_size)
    elif args.model_type == "vitb16_imgnet":
        model = load_model_vitb16imgnet(class_num, layers_freeze, img_size)
    print("Loading training DataLoader: ")
    train_dataloader = load_data(TRAIN_CSV, TRAIN_IMG_BASE, TRAIN_FND_CROPS, 1, num_workers, batch_size, topk, img_size)  
    print("Loading validation DataLoader: ")
    val_dataloader = load_data(TEST_CSV, TEST_IMG_BASE, TEST_FND_CROPS, 0, num_workers, batch_size, topk, img_size)    
    print("Now training: \n\n")
