...
if __name__=="__main__":
    ...
    num_workers = 8
    batch_size = 4
    plot_path = './vision_table_1/vitb_16_clip/result_auc_plot.png'
    score_file = './vision_table_1/vitb_16_clip/result_scores.txt'
    logits_save = './vision_table_1/vitb_16_clip/logits_labels.npy'
    topk = 8
    img_size = 224
