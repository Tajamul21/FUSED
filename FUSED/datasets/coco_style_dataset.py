...
class CocoStyleDataset(CocoDetection):
    ...
    img_dirs = {
        ...
        'sim10k': {
             'test': 'sim10k/test2017',
        },
        'cityscapes_target': {
             'test': 'cityscapes_target/val2017',
        },
        'cityscapes_source': {
             'test': 'cityscapes_source/test2017',
        },
        'foggycityscapes': {
             'test': 'foggy_cityscapes/leftImg8bit_foggy/val2017',
        },
        'bdd100k': {
             'test': 'bdd100k/images/100k/val2017',
            #  'test': 'bdd100k/images/100k/train2017',
        },
        'kitti': {
             'test': 'bdd100k/images/100k/train2017',
            #  'test': 'bdd100k/images/100k/train2017',
        ...
        'cview': {
             'train': 'c_view_data/common_cview/train2017',
             'test': 'c_view_data/common_cview/val2017',
        },
    ...
    anno_files = {
        'inhouse': {
            'target': {
                'test': 'AIIMS/annotations/image_info_test-dev2017.json',
            },
        },
        'inbreast': {
            'target': {
                'test': 'INBreast/annotations/image_info_test-dev2017.json',
            },
        },
        'rsna': {
            'target': {
                'test': 'RSNA/annotations/image_info_test-dev2017.json',
            },
        },
        'ddsm': {
            'target': {
                'test': 'DDSM/annotations/image_info_test-dev2017.json',
            },
        },
        'sim10k': {
            'target': {
                'test': 'sim10k/annotations/image_info_test-dev2017.json',
            },
        },
        'cityscapes_target': {
            'target': {
                # 'test': 'cityscapes_target/annotations/instances_val2017.json',
                'test': 'cityscapes_target/annotations/instances_val2017.json',
            },
        },
        'foggycityscapes': {
            'target': {
                'test': 'foggy_cityscapes/leftImg8bit_foggy/annotations/instances_val2017.json',
            }
        },
        'bdd100k': {
            'target': {
             'test': 'bdd100k/images/100k/annotations/instances_val2017.json',
            #  'test': 'bdd100k/images/100k/annotations/instances_train2017.json',
            #  'test': 'bdd100k/images/100k/annotations/instances_val2017_old5000samples_otherone_is_1k.json',
            }
        },
        'cview': {
            'target': {
                'train': 'c_view_data/common_cview/annotations/instances_train2017.json',
                'test': 'c_view_data/common_cview/annotations/instances_val2017.json',
            }
        },
        'kitti': {
            'target': {
